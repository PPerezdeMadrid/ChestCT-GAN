...
"""
TRAIN: train, get_torch_variable,check_cuda, evaluate, calculate_gradient_penalty
"""
...
class WGAN_GP(object):
    ...
    def train(self, train_loader):
        ...
        self.mone = torch.FloatTensor([-1]).to(self.device)
        ...
        for g_iter in range(self.generator_iters):
            ...
            if (g_iter) % SAVE_PER_TIMES == 0:
                ...
                # linea maldita
                info = {
                    'Wasserstein distance': str(Wasserstein_D),
                    'Loss D': str(d_loss),
                    'Loss G': str(g_cost),
                    'Loss D Real': str(d_loss_real),
                    'Loss D Fake': str(d_loss_fake)
