...
def adjust_brightness(image_path, target_brightness=28):
    ...
    if current_brightness < target_brightness:
        ...
        img = enhancer.enhance(factor)  # Increase image brightness
        ...
        print(f"The image brightness is sufficient: {current_brightness:.2f}")

########
# Directory of transformed images
########
transformed_dir = 'Data-Transformed/cancer'

# Iterate over the images in the directory
for filename in os.listdir(transformed_dir):
    if filename.lower().endswith('.png'):  # Only work with PNG files
